    	...
    	$record = Products::where('id', $id)
            ->with([
                ...
                'sizes' => function($query) {
                    $query->select(['sizes.id', 'sizes.size_title', 'sizes.from_cm',  'sizes.to_cm',  'sizes.length', 'price','sale_price','color_id', 'product_sizes.status','product_sizes.non_exchange'])->orderBy('product_sizes.id', 'asc');
                },
