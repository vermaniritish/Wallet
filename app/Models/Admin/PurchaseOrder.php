...
class PurchaseOrder extends AppModel
{
    ...
    */
    ...
    public static function getListing(Request $request, $where = [])
    {
        ...
        ->leftJoin('admins as owner', 'owner.id', '=', 'purchase_orders.created_by')
    ...
    * @param $limit
    */
    public static function getAll($select = [], $where = [], $orderBy = 'purchase_orders.id desc', $limit = null)
    {
    	$listing = PurchaseOrder::orderByRaw($orderBy);
    ...
    */
    ...
    {
    	$record = PurchaseOrder::where('id', $id)
            ->with([
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'purchase_orders.id desc')
    {
    	$record = PurchaseOrder::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return PurchaseOrder::whereIn('purchase_orders.id', $ids)
		    		->update($data);
	    }
	    else
	    {
