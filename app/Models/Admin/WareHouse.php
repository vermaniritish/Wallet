...
class WareHouse extends AppModel
{
    ...
    */
    ...
    public static function getListing(Request $request, $where = [])
    {
        ...
        ->leftJoin('admins as owner', 'owner.id', '=', 'ware_houses.created_by')
    ...
    * @param $limit
    */
    public static function getAll($select = [], $where = [], $orderBy = 'ware_houses.id desc', $limit = null)
    {
    	$listing = WareHouse::orderByRaw($orderBy);
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'ware_houses.id desc')
    {
    	$record = WareHouse::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return WareHouse::whereIn('ware_houses.id', $ids)
		    		->update($data);
	    }
	    else
	    {
