				...
				<div class="row">
					<div class="col-md-12">
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="active" name="status" value="pending" <?php echo (!isset($_GET['status']) || $_GET['status'] === '' || $_GET['status'] === '0' ? 'checked' : '') ?> class="custom-control-input">
							<label class="custom-control-label" for="active">Pending / Failed</label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="nonactive" name="status" value="completed" <?php echo (isset($_GET['status']) && $_GET['status'] == '0' ? 'checked' : '') ?> class="custom-control-input">
							<label class="custom-control-label" for="nonactive">Completed</label>
						</div>
					</div>
				</div>
			</div>
