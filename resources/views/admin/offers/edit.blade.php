			...
			<div class="card">
				...
				<div class="card-header">
					<div class="row align-items-center">
						<div class="col-8">
							<h3 class="mb-0">Update Offer Details Here.</h3>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.offers.edit', ['id' => $page->id]) ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
						...
						<div class="pl-lg-4">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="description" required placeholder="Description" value="{{ old('description', $page->description) }}">
								@error('description')
								    <small class="text-danger">{{ $message }}</small>
								@enderror
							</div>
							...
							<div class="row my-2" >
								<div class="form-group col-md-6">
									...
									<input type="number" class="form-control" name="quantity" min="1" required placeholder="5" value="{{ old('quantity', $page->quantity) }}">
									@error('quantity')
										<small class="text-danger">{{ $message }}</small>
									@enderror
								</div>
								<div class="form-group col-md-6 d-none" id="case-2-offers">
									...
									<input type="number" class="form-control" name="offer_total_price" min="1" required placeholder="5000" value="{{ old('offer_total_price', $page->offer_total_price) }}">
								...
								<div class="form-group col-md-6 d-none" id="case-3-offers">
									...
									<input type="number" class="form-control" name="free_logo" min="1" required placeholder="2" value="{{ old('free_logo', $page->free_logo) }}">
									@error('free_logo')
										<small class="text-danger">{{ $message }}</small>
									@enderror
								</div>
									...
									<div class="form-group">
										<div class="custom-control">
											<label class="custom-toggle">
												...
												<input type="checkbox" name="status" value="1" <?php echo (old('status', $page->status) != '0' ? 'checked' : '') ?>>
