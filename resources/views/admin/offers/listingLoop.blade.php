	...
	<td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'offers', 'field' => 'status', 'id' => $row->id]); ?>
	...
	<?php if(Permissions::hasPermission('offers', 'update') || Permissions::hasPermission('offers', 'delete')): ?>
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				<a class="dropdown-item" href="<?php echo route('admin.offers.view', ['id' => $row->id]) ?>">
					<i class="fas fa-eye text-yellow"></i>
					<span class="status">View</span>
				</a>
				<?php if(Permissions::hasPermission('offers', 'update')): ?>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo route('admin.offers.edit', ['id' => $row->id]) ?>">
				...
				<?php if(Permissions::hasPermission('offers', 'delete')): ?>
					...
					<a 
						...
						href="javascript:;"
						data-link="<?php echo route('admin.offers.delete', ['id' => $row->id]) ?>"
					>
