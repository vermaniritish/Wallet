					...
					<form method="post" action="<?php echo route('admin.products.categories.edit', ['id' => $category->id]) ?>" class="form-validation">
						...
						<div class="pl-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="meta_title" placeholder="Meta Title" value="<?php echo $category->meta_title ?>">
								@error('meta_title')
								    <small class="text-danger">{{ $message }}</small>
								@enderror
							</div>
							<div class="form-group">
								...
								<textarea rows="2" class="form-control" placeholder="Your description" name="meta_description"><?php echo $category->meta_description ?></textarea>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="meta_keywords" placeholder="Meta Keywords" value="<?php echo $category->meta_keywords ?>">
								@error('meta_keywords')
								    <small class="text-danger">{{ $message }}</small>
								@enderror
							</div>
