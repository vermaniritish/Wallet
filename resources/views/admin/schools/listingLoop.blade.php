	...
	<td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'schools', 'field' => 'status', 'id' => $row->id]); ?>
	...
	<?php if(Permissions::hasPermission('schools', 'update') || Permissions::hasPermission('schools', 'delete')): ?>
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				<a class="dropdown-item" href="<?php echo route('admin.schools.view', ['id' => $row->id]) ?>">
					<i class="fas fa-eye text-yellow"></i>
					<span class="status">View</span>
				</a>
				<?php if(Permissions::hasPermission('schools', 'update')): ?>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo route('admin.schools.edit', ['id' => $row->id]) ?>">
				...
				<?php if(Permissions::hasPermission('schools', 'delete')): ?>
					...
					<a 
						...
						href="javascript:;"
						data-link="<?php echo route('admin.schools.delete', ['id' => $row->id]) ?>"
					>
