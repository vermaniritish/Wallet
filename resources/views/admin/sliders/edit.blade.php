						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Heading" required name="heading" value="{{ old('heading', $page->heading) }}">
									@error('heading')
										<small class="text-danger">{{ $message }}</small>
									@enderror
								</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Small Text" required name="small_text" value="{{ old('small_text', $page->small_text	) }}">
									@error('small_text')
										<small class="text-danger">{{ $message }}</small>
									@enderror
								</div>
