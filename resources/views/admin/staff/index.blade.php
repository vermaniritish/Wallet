							...
							<thead class="thead-light">
								<tr>
									...
									<th class="sort" width="15%">
										Auth Id
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'staff.password' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="staff.password" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'staff.password' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="staff.password" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="staff.password"></i>
										<?php endif; ?>
									</th>
