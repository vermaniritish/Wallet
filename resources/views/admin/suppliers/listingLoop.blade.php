	...
	<td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'suppliers', 'field' => 'status', 'id' => $row->id]); ?>
	...
	<?php if(Permissions::hasPermission('suppliers', 'update') || Permissions::hasPermission('suppliers', 'delete')): ?>
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
				<a class="dropdown-item" href="<?php echo route('admin.suppliers.view', ['id' => $row->id]) ?>">
					<i class="fas fa-eye text-yellow"></i>
					<span class="status">View</span>
				</a>
				<?php if(Permissions::hasPermission('suppliers', 'update')): ?>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo route('admin.suppliers.edit', ['id' => $row->id]) ?>">
				...
				<?php if(Permissions::hasPermission('suppliers', 'delete')): ?>
					...
					<a 
						...
						href="javascript:;"
						data-link="<?php echo route('admin.suppliers.delete', ['id' => $row->id]) ?>"
					>
