			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						<a href="<?php echo route('admin.suppliers') ?>" class="btn btn-neutral"><i class="fa fa-arrow-left"></i> Back</a>
							...
							<div class="dropdown" data-toggle="tooltip" data-title="More Actions">
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
									<?php if(Permissions::hasPermission('suppliers', 'update')): ?>
										<a class="dropdown-item" href="<?php echo route('admin.suppliers.edit', ['id' => $page->id]) ?>">
									...
									<?php if(Permissions::hasPermission('suppliers', 'delete')): ?>
										...
										<a 
											...
											href="javascript:;"
											data-link="<?php echo route('admin.suppliers.delete', ['id' => $page->id]) ?>"
										>
