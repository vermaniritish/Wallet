			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						<a href="<?php echo route('admin.wareHouses') ?>" class="btn btn-neutral"><i class="fa fa-arrow-left"></i> Back</a>
							...
							<div class="dropdown" data-toggle="tooltip" data-title="More Actions">
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
									<?php if(Permissions::hasPermission('ware_houses', 'update')): ?>
										<a class="dropdown-item" href="<?php echo route('admin.wareHouses.edit', ['id' => $page->id]) ?>">
									...
									<?php if(Permissions::hasPermission('ware_houses', 'delete')): ?>
										...
										<a 
											...
											href="javascript:;"
											data-link="<?php echo route('admin.wareHouses.delete', ['id' => $page->id]) ?>"
										>
				...
				<div class="card">
					...
					<div class="card-header">
						<div class="row align-items-center">
							<div class="col-8">
								<h3 class="mb-0">Ware House Information</h3>
							</div>
						</div>
					</div>
					<div class="table-responsive">
						...
						<table class="table align-items-center table-flush">
							<tbody>
								...
								<tr>
									<th>Manager Name</th>
									<td><?php echo $page->manager_name ?></td>
								</tr>
								<tr>
									<th>Phone Number</th>
