            ...
            <div class="col-md-6">
                ...
                <div class="voucher-preview shadow">
                    ...
                    <p><span id="previewName">This voucher entitles the bearer to make purchases worth 
                        <strong v-if="form.amount && form.amount != 'custom'">@{{ form.amount ? `£` + form.amount : '£---'  }}</strong>
                        <strong v-else-if="form.customAmount">@{{ form.customAmount ? `£` + form.customAmount : '£---'  }}</strong>
