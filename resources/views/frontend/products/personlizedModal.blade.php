					...
					<div class="inline-row">
						...
						<div class="inline-box">
							<div class="d-flex flex-row justify-content-between align-items-start mb-2">
								<button class="btn btn-sm btn-primary" :disabled="(lVal.text.trim() || lVal.text1.trim() || lVal.text2.trim()) ? true : false" v-on:click="handleFileUpload(i, lKey)"><i v-if="uploading !== null && uploading.sizeIndex && uploading.sizeIndex == i" class="fa fa-spin fa-spinner"></i> <i v-else class="fa fa-upload"></i> Upload Logo</button>
							...
							<label>
								...
								:name="`already_uploaded_${i}_${lKey}`"
								value="1"
								:disabled="(lVal.text.trim() || lVal.text1.trim() || lVal.text2.trim()) ? true : false"
