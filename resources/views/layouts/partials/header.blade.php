                ...
                <div class="language__currency d-none d-lg-block">
                    <ul class="header__shipping--wrapper d-flex">
                        ...
                        <li class="header__shipping--text text-white d-sm-2-none"><img
                                class="header__shipping--text__icon" src="{{ url('frontend/assets/img/icon/bus.png') }}"
            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="/"><img
                                class="main__logo--img" src="{{ url('frontend/assets/img/logo/logo-workwear.jpg') }}"
                                alt="logo-img"></a>
                    </h1>
                </div>
                    ...
                    <ul class="d-flex">
                        <li class="header__account--items">
                            ...
                            <a class="header__account--btn"
                                href="{{ $user && $user->id ? url('/my-account') : url('/login') }}">
                                    ...
                                    <ul class="header__sub--menu">
                                        @foreach ($menuItem->megaMenu as $s)
                                            <li class="header__sub--menu__items">
                                                <a href="{{ $s->link }}"
                                                    class="header__sub--menu__link">{{$s->title}}</a>
                                                </li>
                                        @endforeach
                                    </ul>
                                @endif
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <?php if($submenu && $submenu->count() > 0): ?>
                                        ...
                                        @foreach ($submenu as $s)
                                            <li class="header__sub--menu__items">
                                                <a href="{{ url('/' . Str::slug($m->title)) . '/' . $s->slug }}"
                                                    class="header__sub--menu__link">{{$s->title}}</a>
                                                </li>
                                        @endforeach
                                        </ul>
